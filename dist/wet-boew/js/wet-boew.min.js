...
(function (global, factory) {
  ...
  */
  ...
  $document.on( "timerpoke.wb " + initEvent + " keydown redraw" + selector +
  ...
  var i18nText,
      ...
      init = function() {
          ...
          $calBase = $( "<div class='wb-clndr' role='application'>" +
              "<div class='cal-nav'>" +
                  "<span class='wb-inv current-month' aria-live='polite'></span>" +
      ...
      initCalendar = function( settings ) {
          ...
          $('.current-month').html("Current month: " + $calendarObj.find(".cal-month option[value=" + this.month + "]").text());
  ...
  */
  ...
  const componentName = "wb-tagfilter",
      ...
      initEvent = "wb-init" + selector,
      $document = wb.doc,
      filterOutClass = "wb-fltr-out", // Leverage .wb-fltr-out already defined for the Filter plugin
      ...
      refineFilters = function( instance ) {
          ...
          for ( let filterGroupName in instance.filters ) {
              ...
              if ( filterGroup[ 0 ].type === "checkbox" ) {
              ...
              } else if ( filterGroup[ 0 ].type === "radio" ) {
                  if ( filterGroupCnt > 1 && filterGroupChkCnt > 0 ) {
                      let radioChkdItem;
              ...
              } else if ( filterGroup[ 0 ].type === "select-one" ) {
      ...
      matchItemsToFilters = function( instance ) {
          ...
          instance.items.forEach( function( item ) {
              ...
              if ( filterMatchCount === filtersGroups ) {
                item.isMatched = true;
                matchedItemsCount++
              } else {
  ...
  $document.on( "change", selectorCtrl, function( event )  {
      ...
      if ( filterType === "checkbox" ) {
          ...
          let filterName = control.getAttribute( "name" );
